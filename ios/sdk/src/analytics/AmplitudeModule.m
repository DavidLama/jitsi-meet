...
RCT_EXPORT_METHOD(setUserProperties:(NSString*)instanceName userPropsString:(NSString*)userPropsString) {
    NSError *error;
    ...
    if (userProperties == nil) {
        NSLog(@"[Amplitude handler] Error parsing user properties: %@", error);
    } else {
        [[Amplitude instanceWithName:instanceName] setUserProperties:userProperties];
    }
}
